              ...
              <div className="grid grid-cols-1 sm:grid-cols-[58%_27%] gap-10 justify-between">
                        ...
                        <div className="flex gap-8 items-center">
                          ...
                          <div>
                            ...
                            <ul className="space-y-2 mt-3">
                              <li className="font-semibold text-[17px]">Price : <span className="font-normal text-[16px] ">&nbsp; Rs. {product.price} </span> </li>
                              <li className="font-semibold text-[17px]">Quantity :  <span className="font-normal text-[16px] ">&nbsp; {product.quantity} </span> </li>
                ...
                <div className="border-2 rounded-md shadow-md p-3">
                  ...
                  <ul className="space-y-4 mt-4">
                    <li className="font-semibold text-[17px]">Item(s) Subtotal : <span className="font-normal text-[16px] ">&nbsp; ₹ {totalamount}</span> </li>
                    ...
                    <li className="font-semibold text-[17px]">Grand Total: <span className="font-normal text-[16px] ">&nbsp; ₹ {totalamount} </span> </li>
                  </ul>
                </div>
              </div>
            </div>
                ...
                <tbody>
                  {
                    orders.map((order, index) => {
                      // console.log(order);
                      const totalamount = order.productInfo.reduce((acc, product) => acc + product.price * product.quantity, 0);
                      return (
                        <tr key={index} className="bg-white border-b">
                          <th
                            ...
                            <input
                              ...
                              type="checkbox"
                              value=""
                              onClick={() => singleCheck(order._id)}
                              checked={checkedValue.includes(order._id) ? 'checked' : ''}
                          ...
                          <td className="px-6 py-4 text-center">{order.productInfo.length}</td>
